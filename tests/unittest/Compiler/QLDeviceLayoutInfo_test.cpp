...
// Trimmed to the keys QLDeviceLayoutInfo itself reads, mirroring the shape of
// the four v2.8 samples supplied with the request
// (config.json/config_{fixed,custom,auto,resources}.json).
